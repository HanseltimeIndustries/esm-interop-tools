...
import { PackageGraph, PackageInfo, Node, PackageInfoKey } from '../packageGraphs'
import { join } from 'path'


function resolvePkgPath(pkgDir: string, pkgName: string, options: {
...
export async function getESMPackages(pkgGraph: PackageGraph,) {
    ...
    async function resolvePackageJsons(currentNode: Node<PackageInfo, PackageInfoKey>, previousOptions?: VisitReturn): Promise<[VisitReturn, boolean]> {
